...
<head>
    <title>General Information - 4th International Pediatric Updates Symposium</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="xs-heading col-md-8">
                            <h3 class="xs-title">General Information</h3>
                        </div><!-- .xs-heading END -->
                    </div><!-- .row END -->
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-bordered table-striped table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="https://www.internationalpediatricupdatessymposium.org/">internationalpediatricupdatessymposium.org</a></td>
                                    </tr>
                                    <tr>
                                        <td><b>Attendees</b></td>
                                        <td>150</td>
