...
<head>
    <title>Registration - 3rd International Pediatric Updates Symposium</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="xs-heading col-md-8">
                            <h3 class="xs-title">Registration & Accommodation</h3>
                        </div><!-- .xs-heading END -->
                    </div><!-- .row END -->
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="content-heading heading-v2">
                                <h3 class="content-title">Registration</h3>
                            ...
                            <ul class="list-disc">
                                ...
                                <li>Visiting the exhibition and booth areas organized by the companies and participating in company activities.</li>
                                <li>Participation in satellite symposiums.</li>
                            </ul>
                    ...
                    <div class="row" style="padding-top: 40px;">
                        <div class="col-lg-12">
                            <div class="content-heading heading-v2">
                                <h3 class="content-title">Accomodation</h3>
                                <span class="xs-separetor"></span>
                            </div>
                            <table class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        <th>Accomodation</th>
                                        <th>Hotel Single Room</th>
                                        <th>Double Room Second Person Difference</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                    ...
                    <div class="row" style="padding-top: 40px;">
                        <div class="col-lg-12">
                            <div class="content-heading heading-v2">
                                <h3 class="content-title">Cancellation Conditions</h3>
                                <span class="xs-separetor"></span>
                            </div>
                        </div>
                        <div class="col-lg-12">
