                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="xs-heading col-lg-12">
                            <img style="max-width: 80%;" src="/doc/scientific-program-en-1.png" alt="Scientific Program" title="Scientific Program">
                            <img style="max-width: 80%; margin-top: 20px;" src="/doc/scientific-program-en-2.png" alt="Scientific Program" title="Scientific Program">
                        </div>
                    </div><!-- .row END -->
                </div><!-- .container END -->
